...
R.table("rows", "Measurements", [{"key": "batch", "label": "Batch"}, {"key": "tokens_per_sec", "label": "Tokens/s", "fmt": "int"}, {"key": "latency_ms", "label": "Latency ms", "fmt": "num"}, {"key": "peak_gb", "label": "Peak GB", "fmt": "num"}], batch_rows)
