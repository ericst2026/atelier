...
R.chart("fit", "The fit", curve, "params", [{"key": "fit", "label": "L(N) = E + A·N^(−α)", "color": "hold", "form": "line"}, {"key": "measured", "label": "Measured", "color": "kept", "form": "scatter"}], "line", x_log=True, y_log=True, note="The fitted line continues past the last measured point; the next step trains that model and checks it.")
