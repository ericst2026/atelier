...
A generator repeats its own templates, so this is not a formality: leave it out
and the vocabulary over-fits to whichever sentence pattern came up most often."""
import os
...
parse_args()
P = params({"lowercase": True, "collapse_ws": True, "strip_punct": False, "near": True, "shingle": "word", "n": 4, "threshold": 0.8, "keep": "first"})
I = inputs()
