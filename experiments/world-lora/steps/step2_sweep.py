...
R.chart("cost", "Memory and time by rank", results, "rank", [{"key": "peak_gb", "label": "Peak GB", "color": "raw"}, {"key": "seconds", "label": "Seconds", "color": "hold", "axis": "right"}], "bar", note="Barely moves. LoRA's saving is in optimizer state, and at this model size the activations dominate anyway.")
