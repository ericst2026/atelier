...
from lib_bench import mfu, time_steps  # noqa: E402
...
R.metric("mfu", "Model FLOPs utilisation", best["mfu"], "pct", "sky", help="share of the A6000's bf16 peak actually used")
R.metric("peak_gb", "Peak memory", best["peak_gb"], "num", "hold", help="of 48 GB")
...
R.chart("throughput", "Throughput against batch size", rows, "batch", [{"key": "tokens_per_sec", "label": "Tokens per second", "color": "kept"}, {"key": "peak_gb", "label": "Peak GB", "color": "raw", "axis": "right"}], "line", note="Throughput flattens once the GPU is saturated; past that point a larger batch only costs memory.")
R.chart("mfu", "Utilisation against batch size", rows, "batch", [{"key": "mfu", "label": "MFU", "color": "sky"}], "line", y_domain=[0, 1])
